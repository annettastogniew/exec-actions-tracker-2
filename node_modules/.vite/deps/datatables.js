...
var require_jquery_dataTables = __commonJS({
  "node_modules/datatables/media/js/jquery.dataTables.js"(exports, module) {
    (function(factory) {
      "use strict";
      ...
      function _fnCreateTr(oSettings, iRow, nTrIn, anTds) {
        ...
        if (row.nTr === null) {
          ...
          for (i = 0, iLen = oSettings.aoColumns.length; i < iLen; i++) {
            ...
            nTd = nTrIn ? anTds[i] : document2.createElement(oCol.sCellType);
            nTd._DT_CellIndex = {
              row: iRow,
              column: i
            };
      ...
      _Api.extend = function(scope, obj, ext) {
        ...
        var i, ien, j, jen, struct, inner, methodScoping = function(scope2, fn, struc) {
          return function() {
      ...
      _Api.registerPlural = _api_registerPlural = function(pluralName, singularName, val) {
        ...
        _Api.register(singularName, function() {
          ...
          if (ret === this) {
            ...
            return ret.length ? $.isArray(ret[0]) ? new _Api(ret.context, ret[0]) : (
